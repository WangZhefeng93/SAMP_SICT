...
public class EditCoastInfoActivity extends AppCompatActivity {
    ...
    private EditText edit_coast_price_et;   //耗材单价
    ...
    private String edit_coast_price_value = "";
    ...
    private void initWidget() {
        ...
        edit_coast_price_et = (EditText) findViewById(R.id.edit_coast_price_et);    //耗材单价
    ...
    private void setOnCLickListenerForSaveTV() {
        edit_coast_save_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit_coast_price_value = edit_coast_price_et.getText().toString();
                ...
                Log.d("编辑仪器单价值：",edit_coast_price_value);
